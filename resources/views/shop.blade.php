    ...
    <div class="container">
        <div class="row">
                                    ...
                                    @foreach ($brands as $brand )
                                        <li>
                                            <div class="form-check ps-0 custome-form-check">
                                                <input class="checkbox_animated check-it" id="br1{{$brand->id}}" name="brands" @if(in_array($brand->id,explode(",",$q_brands))) checked="checked" @endif value="{{$brand->id}}" type="checkbox" onchange="filterProductByBrand(this)">
            ...
            <div class="category-product col-lg-9 col-12 ratio_30">
                                ...
                                <div class="page-view-filter">
                                    <div class="dropdown select-featured">
                                        <select class="form-select" name="orderby" id="orderby">
                                            <option value="-1"{{$order == -1? 'selectd':''}}>Default</option>
                                            <option value="1"{{$order == 1? 'selectd':''}}>Date, New To Old</option>
                                            <option value="2"{{$order == 2? 'selectd':''}}>Date, Old To New</option>
                                            <option value="3"{{$order == 3? 'selectd':''}}>Price, Low To High</option>
                                            <option value="4"{{$order == 4? 'selectd':''}}>Price, High To Low</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="dropdown select-featured">
                ...
                {{$products->withQueryString()->links("pagination.defult")}}
                ...
                $.ajax({
                        ...
                        if(data.status==200)
                    {
                        $.notify({
                            icon:"fa fa-check",
                            title:"sucess!",
                            message:"Item successfully aadded to youtwishlist"
                        });
                    }
                    }
                });
